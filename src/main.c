...
int main(void)
{
	...
	rdpq_text_register_font(FONT_ID, rdpq_font_load_builtin(FONT_BUILTIN_DEBUG_VAR)); //FONT_BUILTIN_DEBUG_MONO
	...
	while (true)
	{
		...
		if (!showSecondText)
		{
			...
			if (tv_type == TV_PAL) { rdpq_text_print(NULL, FONT_ID, 50, 50,  "This console is PAL"); }
			else if (tv_type == TV_NTSC) { rdpq_text_print(NULL, FONT_ID, 50, 50,  "This console is NTSC"); }
			else if (tv_type == TV_MPAL) { rdpq_text_print(NULL, FONT_ID, 50, 50,  "This console is MPAL"); }
		}
		else
		{
			int yPos = 50;
			...
			if (dir_findfirst("rom:/models", &dir) == 0)
			{
				do
				{
					...
					rdpq_text_print(NULL, FONT_ID, 50, yPos, dir.d_name);
					yPos += 15;
				} while (dir_findnext("rom:/models", &dir) == 0);
			}
			
			// rdpq_text_print(NULL, FONT_ID, 50, 50,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 51,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 53,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 56,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 60,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 65,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 71,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 78,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 86,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 95,  "This is a test program with lots of text to see how performance looks!");
			// rdpq_text_print(NULL, FONT_ID, 50, 105, "This is a test program with lots of text to see how performance looks!");
		}
